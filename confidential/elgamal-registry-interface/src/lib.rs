...
pub fn get_elgamal_registry_address(wallet_address: &Address, program_id: &Address) -> Address {
    get_elgamal_registry_address_and_bump_seed(wallet_address, program_id).0
}

solana_address::declare_id!("regVYJW7tcT8zipN5YiBvHsvR5jXW1uLFxaHSbugABg");
