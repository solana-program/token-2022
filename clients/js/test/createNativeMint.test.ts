...
const SOL_MINT_ADDRESS = address("9pan9bMn5HatX4EJdBwg9VgCa7Uz5HL8N1m5D3NdXejP");
...
test('it throws an error when trying to create a native mint that already exists', async (t) => {
    ...
    const duplicateCreationAttempt = sendAndConfirmInstructions(solanaClient, payerKeyPair, [
        getCreateNativeMintInstruction({
            payer: payerKeyPair,
            nativeMint: SOL_MINT_ADDRESS,
        }),
