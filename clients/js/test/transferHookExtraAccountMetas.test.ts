...
it('getDefaultInitializeExtraAccountMetaListInstructionAsync builds the interface initialize instruction', async () => {
    const authority = address('D5jyaVjrWuq7ostc8JYywr3QDPtM6y6TZKG1TgRhZYSp');
...
it('getDefaultUpdateExtraAccountMetaListInstructionAsync builds the interface update instruction', async () => {
    const authority = address('D5jyaVjrWuq7ostc8JYywr3QDPtM6y6TZKG1TgRhZYSp');
    const [extraAccountMetaList] = await findExtraAccountMetaListPda(
        { mint },
        { programAddress: transferHookProgramId },
...
it('getDefaultInitializeExtraAccountMetaListInstructionAsync attaches the signer when the authority signs', async () => {
...
it('getDefaultInitializeExtraAccountMetaListInstructionAsync uses an explicit validation account when provided', async () => {
    const authority = address('D5jyaVjrWuq7ostc8JYywr3QDPtM6y6TZKG1TgRhZYSp');
