...
> {
    ...
    const usesInstructionSysvar = args.equalityProofInstructionOffset !== 0 || args.rangeProofInstructionOffset !== 0;
...
>(
    ...
    const hasInstructionsSysvar = data.equalityProofInstructionOffset !== 0 || data.rangeProofInstructionOffset !== 0;
