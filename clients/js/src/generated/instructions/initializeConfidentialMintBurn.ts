...
export function getInitializeConfidentialMintBurnInstructionDataEncoder(): FixedSizeEncoder<InitializeConfidentialMintBurnInstructionDataArgs> {
    return transformEncoder(
        ...
        value => ({
            ...
            confidentialMintBurnDiscriminator: INITIALIZE_CONFIDENTIAL_MINT_BURN_CONFIDENTIAL_MINT_BURN_DISCRIMINATOR,
        }),
    );
}
...
export type InitializeConfidentialMintBurnInput<TAccountMint extends string = string> = {
    /** The SPL Token mint. */
...
>(
    ...
    return Object.freeze({
        ...
        programAddress,
    } as InitializeConfidentialMintBurnInstruction<TProgramAddress, TAccountMint>);
}
...
>(
    ...
    return {
        ...
        data: getInitializeConfidentialMintBurnInstructionDataDecoder().decode(instruction.data),
    };
}
