...
export function getInitializeMetadataPointerDiscriminatorBytes(): ReadonlyUint8Array {
...
export function getInitializeMetadataPointerMetadataPointerDiscriminatorBytes(): ReadonlyUint8Array {
...
export type InitializeMetadataPointerInput<TAccountMint extends InstructionAccountInput = InstructionAccountInput> = {
