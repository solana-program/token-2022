...
export function getInitializeMintCloseAuthorityDiscriminatorBytes(): ReadonlyUint8Array {
...
export type InitializeMintCloseAuthorityInput<TAccountMint extends InstructionAccountInput = InstructionAccountInput> =
    {
