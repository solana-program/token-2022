...
> {
    ...
    if (!accounts.instructionsSysvarOrContextState.value && args.proofInstructionOffset !== 0) {
        accounts.instructionsSysvarOrContextState.value =
            'Sysvar1nstructions1111111111111111111111111' as Address<'Sysvar1nstructions1111111111111111111111111'>;
    }
    if (args.proofInstructionOffset === 0 && !accounts.instructionsSysvarOrContextState.value) {
        throw new Error('Expected instructionsSysvarOrContextState when proofInstructionOffset is 0');
    }
...
> = {
    ...
    accounts: {
        ...
        /** The source account's owner/delegate or its multisignature account. */
        authority: TAccountMetas[3] | TAccountMetas[4];
    };
...
>(
    ...
    const getNextOptionalAccount = () => {
        if (instruction.accounts.length - accountIndex <= 1) {
            return undefined;
        }
