...
> {
    ...
    const usesInstructionSysvar =
        ...
        args.ciphertextValidityProofInstructionOffset !== 0 ||
    ...
    if (args.ciphertextValidityProofInstructionOffset === 0) {
        if (!accounts.ciphertextValidityRecord.value) {
            throw new Error('Expected ciphertextValidityRecord when ciphertextValidityProofInstructionOffset is 0');
        }
    } else {
        accounts.ciphertextValidityRecord.value = null;
    }
...
> = {
    ...
    accounts: {
        ...
        /** (Optional) Ciphertext validity proof record account or context state account. */
        ciphertextValidityRecord?: TAccountMetas[number] | undefined;
        /** (Optional) Range proof record account or context state account. */
...
>(
    ...
    const hasInstructionsSysvar =
        ...
        data.ciphertextValidityProofInstructionOffset !== 0 ||
    ...
    const minimumNumberOfAccounts =
        ...
        (data.ciphertextValidityProofInstructionOffset === 0 ? 1 : 0) +
    ...
    return {
        ...
        accounts: {
            ...
            ciphertextValidityRecord:
                data.ciphertextValidityProofInstructionOffset === 0 ? getNextAccount() : undefined,
